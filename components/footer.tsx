    ...
    <footer className="border-t">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Leading software development and digital services company, delivering innovative solutions.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/people" className="text-muted-foreground hover:text-primary">Our People</Link></li>
        ...
        <div className="mt-8 pt-8 border-t text-center text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} Software SAVVY Labs. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
